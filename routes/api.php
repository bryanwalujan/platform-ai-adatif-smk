...
Route::middleware(['auth:sanctum', 'school'])->group(function () {
    ...
    Route::get('/files/{path}', [SchoolFileController::class, 'show'])->where('path', '.*');
    Route::get('/pbl-attachments/{project}/{index}', [PblProjectController::class, 'attachment'])->whereNumber('index')->name('pbl.attachment');
    ...
    */
    ...
    Route::middleware('role:admin')->prefix('admin')->group(function () {
        ...
        Route::post('/school/regenerate-code', [SchoolController::class, 'regenerateCode']);
