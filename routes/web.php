...
use App\Http\Controllers\Api\SchoolFileController;
...
use App\Http\Controllers\Web\SchoolSettingsController;
...
Route::middleware(['auth', 'school'])->group(function () {
    Route::get('/school-files/{path}', [SchoolFileController::class, 'show'])->where('path', '.*')->name('school.files');
    Route::get('/school-pbl-attachments/{project}/{index}', [PblProjectController::class, 'attachment'])->whereNumber('index')->name('school.pbl.attachment');
});

Route::prefix('admin')->name('admin.')->middleware(['auth', 'school', 'role:admin'])->group(function () {
    Route::get('/school', [SchoolSettingsController::class, 'edit'])->name('school.edit');
    Route::put('/school', [SchoolSettingsController::class, 'update'])->name('school.update');
    Route::post('/school/regenerate-code', [SchoolSettingsController::class, 'regenerateCode'])->name('school.regenerate');
...
|--------------------------------------------------------------------------
*/
Route::prefix('guru')->name('guru.')->middleware(['auth', 'school', 'role:guru', 'approved'])->group(function () {
    Route::post('/logout', [AuthController::class, 'logout'])->name('logout');
